...
const CATEGORIES = {
  ...
  "😊 Happy": {
    icon: "😊",
    items: [
      "(* ^ ω ^)", "(´｡• ω •｡`)", "(￣ω￣)", "(o･ω･o)", "(＠＾◡＾)", "( ´ ω ` )", "(((o(*°▽°*)o)))", "(≧◡≦)", "(o´∀`o)", "(´• ω •`)", "╰(▔∀▔)╯", "ヽ(o^ ^o)ﾉ", "(◕‿◕)", "(*≧ω≦*)", "＼(≧▽≦)／", "ヽ(o＾▽＾o)ノ", "(*°▽°*)", "٩(｡•́‿•̀｡)۶", "(￣▽￣)", "＼(￣▽￣)／", "(*¯︶¯*)", "٩(◕‿◕)۶", "(o˘◡˘o)", "o(>ω<)o", "( ´ ▿ ` )", "( ◕▿◕ )", "(ᵔ◡ᵔ)", "(˶◜ᴗ◝˶)", "⸜( ´ ꒳ ` )⸝", "(˶^◡^˶)",
      "(＾▽＾)", "ヽ(・∀・)ﾉ", "(*≧ω≦)", "(ﾉ´ヮ`)ﾉ*:･ﾟ✧", "(＊˘︶˘＊)",
  ...
  "😢 Sad": {
    icon: "😢",
    items: [
      "(ノ_<。)", "(μ_μ)", "(ﾉД`)", "o(TヘTo)", "( ; ω ; )", "(｡╯︵╰｡)", "( ╥ω╥ )", "(／ˍ・、)", "(ノ_<、)", "(つω`｡)", "(｡T ω T｡)", "(ﾉω･､)", "o(〒﹏〒)o", "(ಥ﹏ಥ)", "(ಡ‸ಡ)", "˙◠˙", "(っ◞‸◟ c)", "◞‸◟", "( ◞‸◟ )", "( ｡ • ᴖ • ｡)", "(◞‸◟；)", "(·•᷄∩•᷅ )",
  ...
  "😠 Angry": {
    icon: "😠",
    items: [
      "(＃`Д´)", "(`皿´＃)", "( ` ω ´ )", "ヽ( `д´*)ノ", "凸(`△´＃)", "( `ε´ )", "ψ( ` ∇ ´ )ψ", "ヾ(`ヘ´)ﾉﾞ", "ヽ(‵﹏´)ノ", "(ﾒ` ﾛ ´)", "(╬`益´)", "凸( ` ﾛ ´ )凸", "(°ㅂ°╬)", "(ノ°益°)ノ", "(‡▼益▼)", "(╬ Ò﹏Ó)", "(凸ಠ益ಠ)凸", "(ﾉಥ益ಥ)ﾉ", "(¬_¬ꐦ)", "(ꐦ¬_¬)", "( ` ᴖ ´ )", "( ｡ •̀ ᴖ •́ ｡)", "ლ(ಠ益ಠლ)", "۹(๑`^´๑)۶",
  ...
  "😮 Surprised": {
    icon: "😮",
    items: [
      "( ˶°ㅁ°) !!", "Σ(°ロ°)", "(๑°o°๑)", "(°ロ°)", "(∩˃o˂∩)", "(ﾟ。ﾟ)", "( ˶°□°)", "Σ(ﾟДﾟ υ)", "(ㆁ△ㆁ)", "∑(;°Д°)", "ヽ(°〇°)ﾉ", "！！(゜ロ゜ノ)ノ", "( ˶°ㅁ°) ??", "(º∆º)", "(ﾟロﾟ)", "Σ(っ °Д °;)っ",
      "( ﾟдﾟ)", "Σ(ﾟДﾟ)", "∑(O_O；)", "(⊙_⊙)", "Σ(°△°|||)︴",
  ...
  "❤️ Love": {
    icon: "❤️",
    items: [
      "(ﾉ´ з `)ノ", "(￣ε￣＠)", "(˵˘ ³˘˵)", "(っ´ ³ `)っ", "(づ ̄ ³ ̄)づ", "( っ˶´ ˘ `)っ", "(つ≧▽≦)つ", "｡◕‿‿◕｡", "(っᵔ◡ᵔ)っ", "⊂꒰ ´︶` ꒱⊃", "(づ ◕‿◕ )づ", "(⊃｡•́‿•̀｡)⊃", "⊂(´• ω •`⊂)", "(˶ ˘ ³˘)", "(´ ε ` )♡", "♡(˃͈ દ ˂͈ )", "(♡μ_μ)", "♡＾▽＾♡", "(づ｡◕‿‿◕｡)づ♡",
      "(♥ω♥)", "(♡∀♡)", "(づ￣ ³￣)づ", "(˘∀˘)/(μ‿μ) ❤", "♡(｡- ω -｡)",
      "(｡♥‿♥｡)", "(/^▽^)/♡", "(⁄ ⁄•⁄ω⁄•⁄ ⁄)", "❤(ӦｖӦ｡)", "σ(≧ε≦σ) ♡",
      "(〃￣ω￣〃)ゞ", "♡´･ᴗ･`♡", "(´ ∀ ` *)", "（*^３^）/~☆", "(●♡∀♡)",
  ...
  "👋 Greetings": {
    icon: "👋",
    items: [
      "(￣▽￣)ノ", "(°▽°)/", "( ´ ∀ ` )ﾉ", "(＠´ー`)ﾉﾞ", "(´• ω •`)ﾉ", "ヾ(*'▽'*)", "(*°ｰ°)ﾉ", "(o´ω`o)ﾉ", "( ´ ▽ ` )/", "(￣ω￣)/", "( ´ ω ` )ノﾞ", "(≧▽≦)/", "(o´▽`o)ﾉ", "(˶ᵔᗜᵔ˶)ﾉﾞ", "(ᵕ—ᴗ— )ﾉﾞ", "ﾉ(・ω・)ﾉ", "( ﾟ▽ﾟ)/",
      "(＾▽＾)/", "(^-^*)/", "(´･ω･`)/", "ヾ(・ω・*)", "( ´ ▽ ` )ﾉ",
      "ヾ(＾∇＾)", "(o^▽^o)ノ", "＼(^▽^)＼", "(*^▽^)ノ", "ヾ(*⌒ヮ⌒*)ﾉ",
      "ヾ(・ω・）ノ", "ヽ(・∀・)ﾉ", "(っ・∀・)っ", "^_^)/", "(^o^)/~~",
      "ヾ(^∇^)", "ヾ(*´∀`*)ﾉ", "(ﾉ・ω・)ﾉ", "( ° ∀ ° )ﾉﾞ", "＼（＾▽＾）／",
  ...
  "😴 Tired": {
    icon: "😴",
    items: [
      "( ¬⤙¬ )", "( `−ㅿ−´)", "（＝〜＝）", "(¬‚¬)", "(´Д`)", "(¬,.,¬)", "ʕ◍•-•◍ʔ", "ʕ◍ -_- ◍ʔ", "(っ- ‸ - ς)", "( _ _)｡oO", "(っo -｡)", "(っ˕ -｡)", "꒰｡- ᴗ - ｡꒱", "( ´^` )", "( ˘ω˘ )", "(。-ω-)zzZ", "(´-﹏-`)", "(ᵕ_ᵕ)",
      "(－_－) zzZ", "(-_-;)", "(=_=)", "( ´_ゝ｀)", "(-ω-、)",
      "(。-_-。)", "(-。-;)", "（〜＿〜）", "(￣ρ￣)..", "(-.-)",
  ...
  "🤔 Thinking": {
    icon: "🤔",
    items: [
      "σ(￣、￣〃)", "(￣～￣;)", "┐('～`;)┌", "┐(￣ヘ￣;)┌", "(¯ . ¯;)", "(＠_＠)", "(ーー;)", "ლ(ಠ_ಠ ლ)", "(´･_･`)", "(´•▿•)", "◔‸◔?", "(´･ω･`)?", "(⊙.⊙)?", "( ô ‸ ō )", "(¯ ¯٥)", "(ﾟ⊿ﾟ)",
      "(・・ ) ?", "(？。？)", "（？_？）", "(゜.゜)", "ლ(ʘ̆~̆ʘ̆ლ)",
  ...
  "🐱 Animals": {
    icon: "🐱",
    items: [
      "(=^･ｪ･^=)", "(=①ω①=)", "(=`ω´=)", "( =ノωヽ=)", "(=^ ◡ ^=)", "(=^-ω-^=)", "(＾• ω •＾)", "(^=◕ᴥ◕=^)", "( =ω= )", "(^◔ᴥ◔^)", "(^◕ᴥ◕^)", "( Φ ω Φ )", "ฅ(^◕ᴥ◕^)ฅ", "ᓚ₍ ^. .^₎", "( ´(ｴ)ˋ )", "(*￣(ｴ)￣*)", "ヽ(￣(ｴ)￣)ﾉ", "(￣(ｴ)￣)", "⊂(￣(ｴ)￣)⊃", "(／(ｴ)＼)", "ʕ •̀ ω •́ ʔ", "ʕಠᴥಠʔ", "ʕ｡- ˕ -｡ʔ", "ʕ˶´• ᴥ •`˶ʔ", "∪＾ェ＾∪", "∪･ω･∪", "∪￣-￣∪", "U^ｪ^U", "υ´• ﻌ •`υ", "૮ ･ ﻌ･ა", "／(≧ x ≦)＼", "／(･ × ･)＼", "／(=´x`=)＼", "／(^ x ^)＼", "／(＞×＜)＼", "／(˃ᆺ˂)＼", "(•ㅅ•)", "(´• ω •`)づ",
      "(=^･^=)", "(=^･ω･^=)", "ฅ^•ﻌ•^ฅ", "(^=˃ᆺ˂)", "ʕ•ᴥ•ʔ",
  ...
  "🏃 Actions": {
    icon: "🏃",
    items: [
      "(งツ)ว", "~(˘▾˘)~", "〜(꒪꒳꒪)〜", "ヾ(-_- )ゞ", "♪┏(・o･)┛♪", "ヽ(⌐■_■)ノ♪", "┐(´ー｀)┌", "╮(￣▽￣\"\")╭", "┐(￣ヘ￣)┌", "ʅ（◞‿◟）ʃ", "╮(ツ)╭", "┐(´～｀;)┌", "ヽ(ー_ー )ノ", "┐(￣～￣)┌",
  ...
  "😎 Cool": {
    ...
    items: [
      "(^ω~)", "(>ω^)", "( -_・)", "(｡•̀ᴗ-)", "(^_-)", "(･ω<)☆", "(=ω<)",
      "(－ˋ⩊ˊ－)", "( ◡̀_◡́)ᕤ", "ᕙ(` ˘ ´)ᕗ", "( ͡º ꒳ ͡º)", "(˵ ¬ᴗ¬˵)", "(,,¬﹏¬,,)", "(¬_¬\")", "ψ(｀︶´)ψ", "(-、-)", "(¬v¬)", "( ¬ᴗ¬)", "( ¬⩊¬)", "(¬ ͜ ͡¬)", "◉‿◉", "(≖_≖ )", "(・_・ )", "(≖-≖)", "(⊙＿⊙')", "⊙.⊙", "(՞◔ ㉦ ◔՞)", "( ⌐■_■)",
  ...
  "😨 Scared": {
    icon: "😨",
    items: [
      "(ノωヽ)", "(／。＼)", "(ﾉ_ヽ)", "(″ロ゛)", "(/_＼)", "〜(＞＜)〜", "(((＞＜)))", "〣( ºΔº )〣", "(°□°;)", "(ó﹏ò｡)", "(つ﹏⊂)", "( ˶ó‸ò )", "(ಠᯅಠ)", "(｡>﹏<)", "(ᵕŏ_ŏ)", "(｡Ó﹏Ò｡)", "ヽ(ﾟДﾟ)ﾉ", "Σ(° Д ° )/", "( •᷄∩ •᷅ )", "(;´༎ຶД༎ຶ`)",
      "(ﾟДﾟ;)", "(|||ﾟДﾟ)", "((( ;°Д°)))", "ヽ(゜ロ゜;)ノ", "(((;꒪ω꒪;)))",
      "(×_×;）", "((d[-_-]b))", "（＞＜）", "(((・・;)", "Σ(-᷅_-᷄๑)",
  ...
  "🙈 Embarrassed": {
    icon: "🙈",
    items: [
      "(*/ω＼)", "(*/。＼)", "(*ﾉωﾉ)", "(*μ_μ)", "( ◡‿◡ *)", "(*ﾉ∀`*)", "(//▽//)", "(//ω//)", "(ノ*°▽°*)", "(*ﾉ▽ﾉ)", "(￣▽￣*)ゞ", "(⁄ ⁄>⁄ ▽ ⁄<⁄ ⁄)", "( 〃▽〃)", "(/▿＼ )", "(〃∇〃)", "(*≧∀≦*)", "(〃ω〃)", "(｡>////<)", "( ꈍ◡ꈍ)", "(≧O≦;)", "(⊃//‿//⊂)", "(¬////¬)", "(⸝⸝> ω <⸝⸝)", "( ⸝⸝´ ᵕ `⸝⸝)", "( ˶´ ᵕ `˶ )", "(*´꒳`*)", "(≧ヮ≦)", "(˶>ω<˶)", "( ,,◕ - ◕,, )", "(//ω//)♡",
      "(⁄ ⁄•⁄ω⁄•⁄ ⁄)", "(*^_^*)", "(/ω＼)", "(ﾉ*>∀<)ﾉ♡", "(〃＾▽＾〃)",
      "(*/▽＼*)", "(〃∀〃)", "(/▽＼)", "(//∇//)", "(*≧▽≦)",
      "(≧艸≦)", "(>///<)", "(*∩_∩*)旦~~", "( ˘ ³˘)♥", "(´∀｀*)ﾉ",
      "(*´▽`*)", "(o^_^o)", "（*/ω＼*）", "(^///^)", "(๑•́ωก̀๑)",
  ...
  "💪 Fighting": {
    icon: "💪",
    items: [
      "ᕙ(˘ ³˘)ᕗ", "ᕙ(`▽´)ᕗ", "ᕦ(òᴥó)ᕥ", "ᕙ(≥ᐁ≤)ᕗ", "ᕙ( ͡° ͜ʖ ͡°)ᕗ", "(•̀ヮ•́)ง", "ᕙ( ò ᗜ ó )ᕗ", "(〃•̀ω•́〃)", "୧(๑•̀⌄•́๑)૭", "o(>< )o", "( ◡̀_◡́)ᕤ",
  ...
  "🎉 Celebrate": {
    icon: "🎉",
    items: [
      "٩(˶´༥`˶)و", "¡¡¡( •̀ ᴗ •́ )و!!!", "＼(＾O＾)／", "(ᴗ͈`ヮ´ᴗ͈)", "( ùᗜú)", "( ≧ v ≦ )", "٩(^ᗜ^ )و", "ヽ(*・ω・)ﾉ", "＼(≧▽≦)／", "(* ^ ▽ ^)/",
      "＼(^▽^)／", "ヽ(>∀<☆)ノ", "☆*:.｡.o(≧▽≦)o.｡.:*☆", "(ﾉ◕ヮ◕)ﾉ*:･ﾟ✧", "★~(◠‿◕✿)",
  ...
  "😞 Disappointed": {
    icon: "😞",
    items: [
      "(´・ω・`)", "(＿　＿)", "( ´_ゝ`)", "(︶︿︶)", "( ´△｀)", "(ﾟ‐ﾟ)", "(´ヘ｀;)", "(・∀・;)", "(￣ヘ￣)", "(；￣Д￣)", "(´ • ︵ • `)", "(´。＿。｀)", "(╯︿╰)", "( ⇀ ‸ ↼ )", "(ー_ー )", "( ˘･_･˘ )", "( ̄□ ̄；)", "(↼_↼)",
    ],
  },
  "🥺 UwU": {
    icon: "🥺",
    items: [
      "(ᵕ◡ᵕ)", "( ˘ ³˘)", "(*ᴗ͈ˬᴗ͈)", "( ｡ᵕ ‸ ᵕ ｡)", "( ˶ˆ ꒳ˆ˵ )", "(꒪ᴗ꒪)", "ฅ(• ﻌ •)ฅ", "(´｡• ᵕ •｡`)", "(ㅅ´ ˘ `)", "ʚ(ᵕ—ᴗ—)ɞ", "(っ˘ω˘ς )", "(˘ᵕ˘)", "( ˶•༝•˶)", "ɷ◡ɷ", "(・ω・)", "(ᴜ ω ᴜ)", "( ◜‿◝ )♡", "(ᵘ ꒳ ᵘ )", "(˶ᵔ ᵕ ᵔ˶)", "( ´ ꒳ ` )",
    ],
  },
  "🎀 Coquette": {
    icon: "🎀",
    items: [
      "꒰ᐢ. .ᐢ꒱", "(˶ᵕ ᵕ˶)", "໒꒰ྀི´ ˘ ` ꒱ྀིა", "ʚ♡ɞ", "♡⸜(ˆ ˗ˆ )⸝", "(˶˃ ᵕ ˂˶)", "(´｡• ᵕ •｡`)♡", "˗ˏˋ♡ˎˊ˗", "꒰♡ˊᵕˋ♡꒱", "(ㅅ´ ˘ `)♡", "૮₍ ˶•⤙•˶ ₎ა", "(づ ᵕ ‸ ᵕ )づ", "ʚ(ꈍ ◡ ꈍ)ɞ", "( ˶ᵔ ꒳ ᵔ˶ )", "꒰ ˶• ༝ •˶꒱", "(♡ᵕ ᵕ )", "໒꒰ ˶• ⤙ •˶꒱১",
    ],
  },
};
